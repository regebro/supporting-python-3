...
sure that the tests run. This makes for a comfortable environment to add
Python 3 support while continuing to support Python 2.
...
have come a long way towards supporting Python 3. It's now time to look into
